...
object ExcelExporter {
    ...
    fun exportMonitoringExcel(context: Context, vibrationLogs: List<VibrationLog>) {
        val dateFormat = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
        val fileDate = SimpleDateFormat("yyyyMMdd_HHmm", Locale.getDefault()).format(Date())
        ...
        vibrationLogs.sortedByDescending { it.timestamp }.forEach { log ->
    ...
    fun exportCiltExcel(context: Context, ciltChecks: List<CiltCheck>) {
        val dateFormat = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
        val fileDate = SimpleDateFormat("yyyyMMdd_HHmm", Locale.getDefault()).format(Date())
        val sb = StringBuilder()
        ...
        ciltChecks.sortedByDescending { it.timestamp }.forEach { c ->
    ...
    fun exportReliabilityPmExcel(context: Context, reports: List<AbnormalityReport>, reliabilityChecks: List<ReliabilityPmCheck>) {
        val dateFormat = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
        val fileDate = SimpleDateFormat("yyyyMMdd_HHmm", Locale.getDefault()).format(Date())
        val sb = StringBuilder()
        ...
        reports.sortedByDescending { it.timestamp }.forEach { rep ->
        ...
        if (reliabilityChecks.isNotEmpty()) {
            ...
            reliabilityChecks.sortedByDescending { it.timestamp }.forEach { chk ->
    ...
    fun exportFlushingExcel(context: Context, flushingLogs: List<FlushingLog>) {
        val dateFormat = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
        val fileDate = SimpleDateFormat("yyyyMMdd_HHmm", Locale.getDefault()).format(Date())
        val sb = StringBuilder()
        ...
        flushingLogs.sortedByDescending { it.timestamp }.forEach { fl ->
